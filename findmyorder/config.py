...
if APP_CONFIG_DIR and os.path.isdir(APP_CONFIG_DIR):
    print(f"FindMyOrder Config: Found TT_CONFIG_DIR: {APP_CONFIG_DIR}")
    ...
    print(f"FindMyOrder Config: TT_CONFIG_DIR not set or invalid ('{APP_CONFIG_DIR}'). Relying on library defaults.")
...
if os.path.exists(DEFAULT_SETTINGS_PATH):
    ...
    print(f"FindMyOrder Config: Warning - Library default not found at {DEFAULT_SETTINGS_PATH}")
...
print(f"FindMyOrder Config: Loading settings from: {settings_files}")
# --- End Modification ---
